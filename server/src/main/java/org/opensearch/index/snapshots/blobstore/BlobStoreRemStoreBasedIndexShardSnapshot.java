...
public class BlobStoreRemStoreBasedIndexShardSnapshot implements ToXContentFragment {
    ...
    private final String primaryTermGenerationPair;
    ...
    private static final String PRIMARY_TERM_GENERATION_PAIR = "primary_term_generation_pair";
    ...
    private static final ParseField PARSE_PRIMARY_TERM_GENERATION_PAIR = new ParseField(PRIMARY_TERM_GENERATION_PAIR);
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(PRIMARY_TERM_GENERATION_PAIR, primaryTermGenerationPair);
    ...
    public BlobStoreRemStoreBasedIndexShardSnapshot(
        String snapshot,
        long indexVersion,
        String primaryTermGenerationPair,
        long startTime,
        long time,
        ...
        this.primaryTermGenerationPair = primaryTermGenerationPair;
    ...
    public static BlobStoreRemStoreBasedIndexShardSnapshot fromXContent(XContentParser parser) throws IOException {
        ...
        String primaryTermGenerationPair = null;
        long indexVersion = -1;
        long startTime = 0;
        long time = 0;
        ...
        if (token == XContentParser.Token.START_OBJECT) {
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                ...
                if (token.isValue()) {
                    ...
                    } else if (PARSE_PRIMARY_TERM_GENERATION_PAIR.match(currentFieldName, parser.getDeprecationHandler())) {
                        primaryTermGenerationPair = parser.text();
     ...
     */
    public String getPrimaryTermGenerationPair() {
        return primaryTermGenerationPair;
    }
     ...
     */
    public BlobStoreRemStoreBasedIndexShardSnapshot asClone(String targetSnapshotName, long startTime, long time) {
        return new BlobStoreRemStoreBasedIndexShardSnapshot(targetSnapshotName, indexVersion, primaryTermGenerationPair, startTime, time, 0, 0, indexUUID, remoteStoreRepository);
    }
