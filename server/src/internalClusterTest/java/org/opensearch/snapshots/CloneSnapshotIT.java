...
public class CloneSnapshotIT extends AbstractSnapshotIntegTestCase {
    ...
    public void testShardClone() throws Exception {
        ...
        final String newShardGeneration = PlainActionFuture.get(
            f -> repository.cloneShardSnapshot(sourceSnapshotInfo.snapshotId(), targetSnapshotId, repositoryShardId, currentShardGen, null ,f)
        );
        ...
        final String newShardGeneration2 = PlainActionFuture.get(
            f -> repository.cloneShardSnapshot(sourceSnapshotInfo.snapshotId(), targetSnapshotId, repositoryShardId, newShardGeneration, null, f)
        );
